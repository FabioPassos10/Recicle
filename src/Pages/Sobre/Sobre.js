          ...
          <Col>
            <div className="col-SobreCard">
              ...
              <div className="CardTexto">
                ...
                <br />
                <p>
                  Fabio exerceu o papel do principal programador do projeto
                  ReCircle, selecionou a linguagem de programação React para o
                  back-end e auxiliou na programação do Mapa, no qual foi
                  portado pelo Leaflet na linguagem JavaScript. Com isso o
                  membro da equipe desenvolveu e auxiliou os demais
                  participantes em diversas amplitudes do projeto. Fabio também
                  foi responsável por elaborar o GitHub do ReCircle, no qual é
                  formado por um código aberto e de fácil acesso.
                  <br />
                </p>
              </div>
              <div className="redes_cardSobre">
