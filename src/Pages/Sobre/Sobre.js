        ...
        <Row xs="1" md="3" sm="2">
          <Col className="bg-light border">
            ...
            <div className="CardPartc1">
              ...
              luctus proin, vulputate sodales dapibus tellus quisque. tristique
              facilisis risus ut mollis commodo fermentum aenean neque, in fusce
              id dictumst potenti vivamus aptent sodales mattis, porttitor per
              felis curabitur donec ornare interdum.
            </div>
          </Col>
          <br />
          <Col className="bg-light border">
